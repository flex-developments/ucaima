...
public class GenerateEncodedSignOfString {
    ...
    public String GenerateEncodedSignOfString(
        ...
        try {
            ...
            String result = server.generateEncodedSignOfString(
                standarSign, 
                string, 
                signAlg
            );
