...
@Stateless
@Path("/gethexhashtosignfromencodedbytes")
/**
 * GetHexHashToSignFromEncodedBytes
 * 
 * @author Ing. Felix D. Lopez M. - flex.developments@gmail.com
 * @version 1.0
 */
public class GetHexHashToSignFromEncodedBytes {
    ...
    public String GetHexHashToSignFromEncodedBytes(
        ...
        try {
            ...
            String result = server.getHexHashToSignFromEncodedBytes(
                signStandard, 
                smime, 
                signAlg
            );
